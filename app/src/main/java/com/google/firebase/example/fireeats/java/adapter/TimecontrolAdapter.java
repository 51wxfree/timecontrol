...
/**
 * RecyclerView adapter for displaying the results of a Timecontrol {@link Query}.
 *
 * Note that this class forgoes some efficiency to gain simplicity. For example, the result of
 * {@link DocumentSnapshot#toObject(Class)} is not cached so the same object may be deserialized
 * many times as the user scrolls.
 */
public abstract class TimecontrolAdapter<VH extends RecyclerView.ViewHolder>
    ...
    public TimecontrolAdapter(Query query) {
        mQuery = query;
    }

    @Override
    public void onEvent(QuerySnapshot documentSnapshots, FirebaseTimecontrolException e) {
        if (e != null) {
