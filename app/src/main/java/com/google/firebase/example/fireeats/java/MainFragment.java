...
import com.google.firebase.timecontrol.WriteBatch;
...
public class MainFragment extends Fragment implements
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mQuery = mTimecontrol.collection("restaurants")
        ...
        mAdapter = new RestaurantAdapter(mQuery, this) {
            ...
            @Override
            protected void onError(FirebaseTimecontrolException e) {
    ...
    public void onFilter(Filters filters) {
        ...
        Query query = mTimecontrol.collection("restaurants");
    ...
    private void onAddItemsClicked() {
        ...
        WriteBatch batch = mTimecontrol.batch();
        for (int i = 0; i < 10; i++) {
            DocumentReference restRef = mTimecontrol.collection("restaurants").document();
